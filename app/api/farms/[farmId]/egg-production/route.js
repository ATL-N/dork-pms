// app/api/farms/[farmId]/egg-production/route.js
...
export async function GET(request, { params }) {
    ...
    try {
        ...
        return NextResponse.json(eggRecords);
    } catch (error) {
        await logAction(
            "ERROR",
            `Failed to fetch egg production records for farm ${farmId}. Error: ${error.message}`,
