...
export default function AddRevenueModal({ isOpen, onClose, onAddRevenue, farmId }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await onAddRevenue({ ...formData, farmId });
      onClose();
    } catch (err) {
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <input
              ...
              onChange={handleChange}
              className="w-full px-3 py-2 border rounded-md"
              placeholder="e.g., Egg Sales, Bird Sales"
              required
            />
          </div>
          <div>
          ...
          <div>
            <label className="block text-gray-700">Customer (Optional)</label>
            <input
              type="text"
              name="customer"
